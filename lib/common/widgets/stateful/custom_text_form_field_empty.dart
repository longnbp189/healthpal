...
class CustomTextFormFieldEmpty extends StatefulWidget {
  const CustomTextFormFieldEmpty({
    super.key,
    this.title,
    this.type,
    this.hintText,
  ...
  @override
  State<CustomTextFormFieldEmpty> createState() =>
      _CustomTextFormFieldEmptyState();
}

class _CustomTextFormFieldEmptyState extends State<CustomTextFormFieldEmpty> {
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            errorText: isChange ? validator(widget._textController.text) : null,
